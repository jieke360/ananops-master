...
CREATE TABLE `an_imc_inspection_item`  (
  ...
  `days` int(20) DEFAULT NULL COMMENT '计划完成天数',
  `frequency` int(20) DEFAULT NULL COMMENT '巡检周期（月）',
  `description` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '巡检子项内容描述',
  `status` int(10) DEFAULT NULL COMMENT '巡检子项的巡检状态',
  `item_latitude` decimal(10, 6) DEFAULT NULL COMMENT '巡检子项的位置，纬度',
  `item_longitude` decimal(10, 6) DEFAULT NULL COMMENT '巡检子项的位置，经度',
  `result` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '巡检子项结果描述',
  `item_name` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '巡检子项的名称',
  `maintainer_id` bigint(20) DEFAULT NULL COMMENT '巡检子项对应的维修工',
  `count` int(10) DEFAULT NULL COMMENT '巡检任务子项已经执行的次数',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 783459180143971329 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `an_imc_inspection_item_log`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 783459182014630913 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `an_imc_inspection_task`  (
  ...
  `task_name` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '巡检任务名称',
  `frequency` int(20) DEFAULT NULL COMMENT '巡检周期（月）',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 783459179120561153 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `an_imc_inspection_task_log`  (
  ...
  `ip_address` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 783459180823448577 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
-- ----------------------------
-- Table structure for an_imc_user_item
-- ----------------------------
DROP TABLE IF EXISTS `an_imc_user_item`;
CREATE TABLE `an_imc_user_item`  (
  `user_id` bigint(20) NOT NULL COMMENT '甲方用户id',
  `item_id` bigint(20) NOT NULL COMMENT '巡检任务子项id'
) ENGINE = InnoDB CHARACTER SET = latin1 COLLATE = latin1_swedish_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for an_imc_user_task
-- ----------------------------
DROP TABLE IF EXISTS `an_imc_user_task`;
CREATE TABLE `an_imc_user_task`  (
  `user_id` bigint(20) NOT NULL COMMENT '甲方用户id',
...
CREATE TABLE `an_mq_message_data`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 783459179120561154 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
