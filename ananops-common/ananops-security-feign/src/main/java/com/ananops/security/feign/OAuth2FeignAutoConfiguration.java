...
public class OAuth2FeignAutoConfiguration {
	 ...
	 */
	@Bean("ananopsClientCredentialsResourceDetails")
	 ...
	 */
	@Bean("ananopsOAuth2RestTemplate")
	 ...
	 */
	@Bean
	public RequestInterceptor oauth2FeignRequestInterceptor(@Qualifier("ananopsOAuth2RestTemplate") OAuth2RestTemplate oAuth2RestTemplate) {
