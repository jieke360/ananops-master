...
public class MdcFormTemplateItem {
    /**
     * 表单模板ID
     */
    @Id
    ...
    /**
     * 获取表单类型（device/inspeContent）
     *
     * @return type - 表单类型（device/inspeContent）
     */
    ...
    /**
     * 设置表单类型（device/inspeContent）
     *
     * @param type 表单类型（device/inspeContent）
     */
