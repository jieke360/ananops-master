//package com.ananops.provider.job.creator;
//
...
//
///**
// * Created by rongshuai on 2019/12/17 15:52
// */
//@Service
...
//
//    public void addNewJob(ElasticJob job,String cron){
//        Class<? extends ElasticJob> jobClass = job.getClass();//获取任务的类
//        //获取Lite作业配置
//        LiteJobConfiguration liteJobConfiguration = getLiteJobConfiguration(getJobType(job),jobClass,cron);
//        //获取作业事件追踪的数据源配置
//        JobEventRdbConfiguration jobEventRdbConfiguration = getJobEventRdbConfiguration("dataSource");
//        //获取作业监听器
//        ElasticJobListener[] elasticJobListeners = createElasticJobListeners(cron);
...
//            new SpringJobScheduler(job, regCenter, liteJobConfiguration, elasticJobListeners).init();
//        } else {
//            new SpringJobScheduler(job, regCenter, liteJobConfiguration, jobEventRdbConfiguration, elasticJobListeners).init();
//        }
//    }
//
//    /**
...
//     */
//    private LiteJobConfiguration getLiteJobConfiguration(final JobType jobType, final Class<? extends ElasticJob> jobClass, String cron) {
//
//        //构建核心配置
//        JobCoreConfiguration jobCoreConfiguration = getJobCoreConfiguration(jobClass.getName(), cron);
//
//        //构建任务类型配置
...
//     */
//    private ElasticJobListener[] createElasticJobListeners(String cron) {
//        List<ElasticJobListener> elasticJobListeners = new ArrayList<>(2);
//
//        //注册每台作业节点均执行的监听
//        ElasticJobListener elasticJobListener = createElasticJobListener(ElasticJobListener.class);
//        if (Objects.nonNull(elasticJobListener)) {
//            elasticJobListeners.add(elasticJobListener);
//        }
//
//        //注册分布式监听者
//        AbstractDistributeOnceElasticJobListener distributedListener = createAbstractDistributeOnceElasticJobListener(AbstractDistributeOnceElasticJobListener.class,
